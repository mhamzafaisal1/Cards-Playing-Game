...
var Deck = (function () {
  ...
  var poker = {
    deck: function deck(_deck4) {
      ...
      function poker(next) {
        ...
        cards.slice(-13).reverse().forEach(function (card, i) {
    ...
    card: function card(_card4) {
      ...
      var rank = _card4.rank;
      var suit = _card4.suit;
  ...
  var poker2 = {
    deck: function deck(_deck4) {
      ...
      _deck4.poker2 = _deck4.queued(poker2);

      function poker2(next) {
        var cards = _deck4.cards;
        var len = cards.length;

        __fontSize = fontSize();

        // CREATING AN ARRAY TO HAVE ALL CARDS
        let arr = new Array()
        let arr1 = new Array()
        let arr2 = new Array()
        let arr3 = new Array()
        let arr4 = new Array()
        cards.slice(-52).forEach(function (card, i) {
          arr.push(card)

        });

        // MAKING 4 CHUNKS OF THE CARDS
        ...
        do {
          for (let index = 0; index < 13; index++) {
            if (count < 13) {
              ...
              arr2.push(arr[index + 13])
            } else if (count >= 26 && count < 39) {
              arr3.push(arr[index + 26])
            } else if (count >= 39 && count < 52) {
              arr4.push(arr[index + 39])
            }
          }
          count += 13;
        ...
        arr1.slice(-13).reverse().forEach(function (card, i) {
          card.poker2(i, len, function (i) {
            card.setSide('back');
            if (i === 4) {
              next();
            }
        ...
        arr2.slice(-13).reverse().forEach(function (card2, i) {
          card2.poker3(i, len, function (i) {
            card2.setSide('front');
            if (i === 4) {
              next();
            }
        ...
        arr3.slice(-13).reverse().forEach(function (card2, i) {
          card2.poker4(i, len, function (i) {
            card2.setSide('back');
            if (i === 4) {
              next();
            }
        ...
        arr4.slice(-13).reverse().forEach(function (card2, i) {
          card2.poker5(i, len, function (i) {
            card2.setSide('back');
            if (i === 4) {
              next();
            }
    ...
    card:
      function card(_card4) {

        var $el = _card4.$el;

        // ORGINAL FUNCTION

        _card4.poker2 = function (i, len, cb) {
          var delay = i * 250;
          ...
          _card4.animateTo({
            ...
            x: Math.round((i + 10.05) * 10 * __fontSize / 16),
            y: Math.round(-250 * __fontSize / 16),  // -110 OLD -210 NEW
            rot: 0,
        ...
        // NEW FUNCTIONS
        // FUNC 1 :
        _card4.poker3 = function (i, len, cb) {
          var delay = i * 250;
          ...
          _card4.animateTo({
            ...
            x: Math.round((i - 30.05) * 10 * __fontSize / 16),
        ...
        _card4.poker4 = function (i, len, cb) {
          var delay = i * 250;
          ...
          _card4.animateTo({
            ...
            x: Math.round((i - 32.05) * 10 * __fontSize / 16),
            y: Math.round(-170 * __fontSize / 16),
            rot: 0,
        ...
        _card4.poker5 = function (i, len, cb) {
          var delay = i * 250;
          ...
          _card4.animateTo({
            ...
            x: Math.round((i + 20.05) * 10 * __fontSize / 16),
            y: Math.round(110 * __fontSize / 16),
            rot: 0,
  ...
  Deck.ease = ease;
  Deck.modules = { bysuit: bysuit, fan: fan, intro: intro, poker: poker, poker2: poker2, shuffle: shuffle, sort: sort, flip: flip };
  Deck.Card = _card;
  Deck.prefix = prefix;
